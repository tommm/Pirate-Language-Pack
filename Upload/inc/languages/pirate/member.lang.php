...
$l['nav_register'] = "Join ye Crew";
$l['nav_activate'] = "Activatin'";
$l['nav_resendactivation'] = "Resend yer Activatin' Parrot";
$l['nav_lostpw'] = "Lost Secret Code";
$l['nav_resetpassword'] = "Reset yer Secret Code";
$l['nav_login'] = "Set Sail";
$l['nav_emailuser'] = "Send a Parrot t' Deckhand";
$l['nav_profile'] = "{1}'s Port";

$l['tpp_option'] = "Be showin' me {1} tales a page";
$l['ppp_option'] = "Be showin' me {1} scrawlin's a page";
$l['account_activation'] = "Crew Activatin'";
$l['activate_account'] = "Crew Activatin'";
$l['activation_code'] = "Activatin' Code";

$l['email_user'] = "Send {1} a Parrot";
$l['email_subject'] = "Parrot Subject";
$l['email_message'] = "Parrot Message";
$l['send_email'] = "Send me Parrot";
$l['error_hideemail'] = "Yer matey be keepin' their Parrot Address a mystery, so yer Parrot doesn't know where to go.";
$l['error_no_email_subject'] = "Yer need to be enterin' a subject for yer Parrot";
$l['error_no_email_message'] = "Ye need a message for yer Parrot to tell yer matey";

$l['login'] = "Set Sail";
$l['pw_note'] = "Be rememberin' that yer Secret Code be noticin' yer trickery.";
$l['lostpw_note'] = "Lost yer Secret Code?";
$l['lost_pw'] = "Lost Secret Code";
$l['lost_pw_form'] = "Lost Secret Code Form";
$l['email_address'] = "Parrot Address:";
$l['request_user_pass'] = "Request yer Pirate Name / Secret Code";
$l['profile'] = "{1}'s Port";
$l['registration_date'] = "Been aboard since:";
$l['date_of_birth'] = "Time o' Sailin':";
$l['birthdayhidden'] = "Be a Mystery";
$l['birthday'] = "Day o' Sailin':";
$l['local_time'] = "Their Sun be at:";
$l['local_time_format'] = "{1} at {2}";
$l['users_forum_info'] = "Cap'n's Log for {1}";
$l['joined'] = "Aboard since:";
...
$l['pm'] = "Bottle a Message:";
$l['send_pm'] = "Send {1} a bottle.";
...
$l['warn'] = "Be Warnin'";
$l['away_note'] = "{1} is out t' sea.";
$l['away_reason'] = "Sailin' for:";
...
$l['users_signature'] = "{1}'s Jolly Rodger";
$l['agreement'] = "Me Ship's Code";
...
$l['registration'] = "Yer Pirate's Info";
$l['required_fields'] = "Boxes ye must be fillin'";
$l['complex_password'] = "<acronym title=\"A Secret Code that be {1} characters long an' has a' upper an' lower case letter, an' a number.\">A Swashbuckling</acronym> Secret Code:";
$l['confirm_email'] = "Confirm yer Parrot:";
...
$l['email_notify_newpm'] = "Send me Parrot when there be new bottles o' messages";
$l['time_offset'] = "Time o' Day (<acronym title=\"Daylight Saving Time\">DST</acronym> correction excluded):";
$l['time_offset_desc'] = "If ye be from a time o' day that differs from me ship, select it from below";
...
$l['request_activation'] = "Request Me Activatin' Code";
$l['ppp'] = "Scrawls a Page:";
$l['ppp_desc'] = "Select how many scrawlin's ye see on a page";
$l['tpp'] = "Tales a Page:";
...
$l['redirect_alreadyloggedout'] = "Ye already been t' Davy Jones' Locker matey.<br />Set a course for t' open seas!";
$l['redirect_lostpwsent'] = "Arrrr! We be sendin' a Parrot wit' squakin' Secret Codes.<br /><br />Set a course for t' open seas!";
$l['redirect_activationresent'] = "Yer activatin' Parrot be resent, arrrr.";
$l['redirect_passwordreset'] = "Yer Secret Code be reset now. There be a Parrot on t' way with a random Secret Code for ye.";
$l['redirect_memberrated'] = "Yer be ratin' this deckhand, arrrr!";
$l['redirect_registered_passwordsent'] = "A random Secret Code be sendin' to yer Parrot Address. Before ye be steppin' aboard me vessel, ye be needin' this Secret Code.";
$l['redirect_validated'] = "Arrrr! Ye be papers be fine.<br />Set a course for t' open seas!";
...
$l['js_validator_not_empty'] = "Ye must be selectin' or writin' a value for this field, 'ere.";
$l['js_validator_checking_username'] = "Checkin' yer Pirate Name...";
$l['js_validator_username_length'] = "Pirate Names be needin' {1} and {2} charactarrrs long.";
