...
$l['purgespammer_purge'] = "Purge Beasty {1}";
$l['purgespammer_purge_desc'] = "Ye be scuttlin' all the Deckhand's content (posts, private messages, events, etc.) and {1} 'em.";
$l['purgespammer_ban'] = "ban";
$l['purgespammer_delete'] = "scuttle";
$l['purgespammer_submit'] = "Purge Beasty";
$l['purgespammer_success'] = "The Beasty has been purged.";
$l['purgespammer_invalid_user'] = "There be no deckhands by that name.";
$l['purgespammer_modlog'] = "Purged Beasty";
